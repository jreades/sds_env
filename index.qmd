...
It might seem strange to have a section on soft-skills as part of our 'preparing to run the Urban Spatial Science platform web site, but knowing [how to ask for help](./skills/help.qmd) and [how to study effectively](./skills/attention.qmd) is *almost* as important as being able to run the code. Almost. Moreover, the skills we discuss here aren't specific to any one module so we've put them here as part of your orientation.
