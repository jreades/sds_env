...
Installing the computing environment entails thinking not *just* about how you run code, but also how you [manage it](./post/git.qmd) and [document it](./post/markdown.qmd). In fact, it's possible to run code without installing anything at all, but by signing up for, installing, or configuring these services *now* you know that you are ready to roll!

We also provide information about [Code Camp](https://jreades.github.com/code-camp/) which is a self-paced introduction to the fundamentals of programming in Python.
