...
To start, you will need to [download Docker](https://www.docker.com) and install it. You must then start the Docker app running before any of these commands will work.
