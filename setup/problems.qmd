...
In Docker especially (less so in Podman) this is a complex process, and you may need assistance, so there is a [Moving to the D Drive page](./moving_to_d.qmd) to try to talk you through the process.
