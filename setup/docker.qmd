...
If you have issues at this point, then you'll need to do [more reading](../docker/index.qmd#installing). However, *most* of you should now be able to connect to the virtual machine by pointing your browser at: [localhost:8888](http://localhost:8888/lab/) where you should see something like this:
