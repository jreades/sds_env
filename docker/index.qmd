...
```bash
docker pull {{< var env.image >}} # Or {{< var env.image >}}-silicon on a M1/M2 Mac
```
...
But don't forget to add `-silicon` to {{< var env.image >}} on a newer Mac with Apple silicon (M1 or M2)!
